document.addEventListener('DOMContentLoaded', function() {
    var postContainer = document.getElementById('post-container-connect');
    var categoryId = 4; // Category ID of the desired category
    var currentPage = 1; // Initial page number
    var viewMoreTrigger = document.getElementById('view-more-trigger-connect');
